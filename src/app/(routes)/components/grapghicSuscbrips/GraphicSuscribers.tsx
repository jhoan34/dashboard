...
export function GraphicSuscribers () {
    return (
        <div className="mt-5">
            <p className="text-3xl mt-3">24.479</p>
            ...
            <div className="h-[350px] ">
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <YAxis />
                        <Tooltip/>
                        <Area type="monotone" dataKey="newCustomers" stroke="#887cfd" strokeOpacity={1} fillOpacity={1} fill="url(#colorUv)"/>
                        <Area type="monotone" dataKey="oldCustomers" stroke="#82ca9d" fill="url(#colorPv)" fillOpacity={1} />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
        </div>
